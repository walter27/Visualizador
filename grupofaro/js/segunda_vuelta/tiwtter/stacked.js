async function getData() {
    const [categoriesResponse, dataResponse] = await Promise.all([
        fetch('../../../data/stacked/segunda_vuelta/twitter/categories.json'),
        fetch('../../../data/stacked/segunda_vuelta/twitter/data.json')
    ]);
...
getData().then(([categories, data]) => {
    ...
    $(function() {
        $('#container').highcharts({
            ...
            title: {
                text: 'Gasto estimado twitter segunda vuelta'
            },
            xAxis: {
