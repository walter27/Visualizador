async function getData() {
    const [categoriesResponse, dataResponse] = await Promise.all([
        fetch('../../../data/stacked/primera_vuelta/instagram/categories.json'),
        fetch('../../../data/stacked/primera_vuelta/instagram/data.json')
    ]);
...
getData().then(([categories, data]) => {
    ...
    $(function() {
        $('#container').highcharts({
            ...
            title: {
                text: 'Gasto estimado instagram primera vuelta'
            },
            xAxis: {
